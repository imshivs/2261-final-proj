...
SOURCES            = clouds.c kitchen.c collisionmap.c collisionmapTemp.c instructions.c intro.c lose.c main.c menu.c myLib.c pause.c scoreboard.c sprites.c text.c win.c
